...
1. **Frontend Component Adaptation** (Step 7 - In Progress)
...
- `app/api/widget-chat/route.ts` (16KB, 447 lines) - Will be replaced by refactored widget route
...
- `components/chat-widget/chat-widget.tsx` - Will need updates to use Vercel AI SDK with widget route
