"use strict";(()=>{(function(){if(window.marlinChatWidgetLoaded){console.warn("Marlin Chat Widget already loaded. Skipping initialization.");return}window.marlinChatWidgetLoaded=!0;let x={position:"bottom-right",title:"Ask Marlin",primaryColor:"#0070f3",bubbleIcon:null,apiEndpoint:"https://marlan.photographytoprofits.com/api/widget-chat",width:"350px",height:"500px",zIndex:9999};function w(){let e=document.createElement("style");e.id="marlin-chat-widget-styles",e.innerHTML=`
